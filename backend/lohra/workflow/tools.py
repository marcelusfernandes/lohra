...
RUN_GUIDANCE = (
    ...
    "(checkpoint_answers={\"sub[<ref>]:<id>\": \"<answer>\"}, with 'template' "
    "in the payload): the bare id answers the PARENT's gate of that name, never "
    "the template's — answer with the key the pause gave you.\n"
