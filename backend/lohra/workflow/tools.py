...
_STATUS_SCHEMA = {
    "description": (
        ...
        "CONCLUDED — today, a leaf that miscounted the sha256/bytes of a file it "
        "really wrote — so the harness measurement stands and the verdict ignores "
        "it; relay it, do not re-run the node over it. "
