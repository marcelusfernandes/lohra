...
RUN_GUIDANCE = (
    ...
    "allow-list; a 'model' the provider does not have runs ONE leaf on the "
    "operator's tier model instead, and reports the swap as an advisory fault "
    "you must relay rather than a run you may call clean. Nodes in the SAME DAG may name DIFFERENT providers, including "
