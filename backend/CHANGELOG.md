...
- CI verifica o wheel do commit em venv isolada com dependências normais, comparando arquivos rastreados com o artefato e a instalação. Smokes cobrem CLI e skills sem provider; diagnóstico e duração distinguem cada fase, e o SHA de checkout é separado do head/base da PR. Os dois jobs Ubuntu existentes mantêm Ruff e suíte completa (#114).
