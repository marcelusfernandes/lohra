...
Runtime Python publicado no PyPI (`pip install lohra`, 0.0.22). Fases 0–10, CC-Parity, Standalone e Waves 4/6/7/7.5/8.1/8.2/8.3 completas; Wave 8 quase fechada (restam #43-B, #60 e o experimento de fan-out); Wave 9 aberta pela taxonomia (#54, `docs/history/reviews/2026-09-03-wave9-t0-taxonomy.md`). Suíte ~2973 testes, 95% cobertura, ruff limpo. O histórico por fase/wave, as pendências nomeadas e o **Próximo** vivem em `docs/STATUS.md` — leia antes de planejar; atualize lá (não aqui) ao fechar uma rodada.
