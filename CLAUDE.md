...
Runtime Python publicado no PyPI (`pip install lohra`, 0.0.21). Fases 0–10, CC-Parity, Standalone e Waves 4/6/7/7.5/8.1/8.2 completas; Wave 8 quase fechada (restam #43-B, #59 e o experimento de fan-out — `docs/history/reviews/2026-09-02-wave8-investigation.md`). Suíte ~2948 testes, 95% cobertura, ruff limpo. O histórico por fase/wave, as pendências nomeadas e o **Próximo** vivem em `docs/STATUS.md` — leia antes de planejar; atualize lá (não aqui) ao fechar uma rodada.
